...
resource "aws_ecs_cluster_capacity_providers" "jenkins_controller_capacity_provider" {
...
resource "aws_ecs_cluster_capacity_providers" "jenkins_agents_capacity_provider" {
